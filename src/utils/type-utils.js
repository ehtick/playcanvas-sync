...
const TEXTUAL_ASSET_TYPES = ['text', 'script', 'css', 'html', 'json', 'shader'];
...
const TypeUtils = {
    ...
    isActiveTextual: function (h, conf) {
        return (
            TypeUtils.isTextualType(h.type) && TypeUtils.isTextualFile(h.name) && conf.ignParser.isMatch(h.remotePath)
        );
    },
